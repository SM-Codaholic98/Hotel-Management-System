     ...
     for j in cust:
        if j==ID:
            ...
            while ans.lower()=='o':
                ...
                if ch=='T':
                    print()
                    t=input("Enter the customer's updated Title as either Mr, Ms or Mrs: ")
                    if t=='Mr' or t=='Ms' or t=='Mrs' or t=='Mx':
                        ...
                        print("~~~ Invalid title of the customer has been entered !!! ~~~")
                        print("--> Please provide the valid title of the customer to update the customer's title field __/\__")
                        print()
                        t=input("Enter the customer's updated Title as either Mr, Ms or Mrs: ").capitalize()
                        if t=='Mr' or t=='Ms' or t=='Mrs' or t=='Mx':
                            cust[j][0]=t
                    ...
                    print()
                    f=input("Enter the customer's updated Full Name: ")
                    cust[j][1]=f
                    print("*** CUSTOMER'S RESTAURANT RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    
                elif ch=='G':
                    print()
                    g=input("Enter the customer's updated Gender as either MALE or M, FEMALE or F, THIRD GENDER or TG: ")
                    if g=='MALE' or g=='FEMALE' or g=='THIRD GENDER' or g=='M' or g=='F' or g=='TG' :
                        ...
                        print("*** CUSTOMER'S RESTAURANT RECORD HAS NOT BEEN UPDATED !!! ***")
                        print("~~~ Invalid sex of the customer has been entered !!! ~~~")
                        print("--> Please provide the valid sex of the customer to update the customer's sex field __/\__")
                        print()
                        g=input("Enter the customer's updated Gender as either MALE or M, FEMALE or F, THIRD GENDER or TG: ").upper()
                        if g=='MALE' or g=='FEMALE' or g=='THIRD GENDER' or g=='M' or g=='F' or g=='TG' :
                            cust[j][4]=g
                            print("*** NOW CUSTOMER'S RESTAURANT RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                        else:
                    ...
                    print()
                    print("// Note:- Mobile/Phone number must be of 10 digits (without ISD code) \\")
                    p=int(input("Enter the customer's updated Mobile/Phone Number: +91 "))
                    if len(str(p))==10:
                        cust[j][3]=p
                        print("*** CUSTOMER'S RESTAURANT RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    else:
                        ...
                        print("*** CUSTOMER'S RESTAURANT RECORD HAS NOT BEEN UPDATED !!! ***")
                        print("~~~ Invalid mobile/phone number of the customer has been entered !!! ~~~")
                        print("--> Please provide the valid mobile/phone number of the customer to update the customer's mobile/phone number field __/\__")
                        print()
                        print("// Note:- Mobile/Phone number must be of 10 digits (without ISD code) \\")
                        p=int(input("Enter the customer's updated Mobile/Phone Number: +91 "))
                        if len(str(p))==10:
                    ...
                    print()
                    e=input("Enter the customer's updated Email Address: ")
                    if '@' and '.com' in g_email:
                        ...
                        print("*** CUSTOMER'S RESTAURANT RECORD HAS NOT BEEN UPDATED !!! ***")
                        print("~~~ customer's email address doesn't contain '@' or '.com' !!! ~~~")
                        print("--> Please provide the proper email address of the customer to update the customer's email address field __/\__")
                        print()
                        g_email=input("Enter the customer's updated Email Address: ")
                        if '@' and '.com' in g_email:
                            cust[j][3]=e
                            print("*** NOW CUSTOMER'S RESTAURANT RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                        else:
