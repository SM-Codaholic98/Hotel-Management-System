     ...
     for j in htl:
        if j==ID:
            ...
            while ans.lower()=='o':
                ...
                if ch=='T':
                    print()
                    t=input("Enter the guest's updated Title as either Mr, Ms or Mrs: ")
                    if t=='Mr' or t=='Ms' or t=='Mrs' or t=='Mx':
                        ...
                        print("~~~ Invalid title of the guest has been entered !!! ~~~")
                        print("--> Please provide the valid title of the guest to update the guest's title field __/\__")
                        print()
                        t=input("Enter the guest's updated Title as either Mr, Ms or Mrs: ").capitalize()
                        if t=='Mr' or t=='Ms' or t=='Mrs' or t=='Mx':
                            htl[j][0]=t
                    ...
                    print()
                    f=input("Enter the guest's updated Full Name: ")
                    htl[j][1]=f
                    print("*** GUEST'S ROOM RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    
                elif ch=='G':
                    print()
                    g=input("Enter the guest's updated Gender as either MALE or M, FEMALE or F, THIRD GENDER or TG: ")
                    if g=='MALE' or g=='FEMALE' or g=='THIRD GENDER' or g=='M' or g=='F' or g=='TG' :
                        ...
                        print("*** GUEST'S ROOM RECORD HAS NOT BEEN UPDATED !!! ***")
                        print("~~~ Invalid sex of the guest has been entered !!! ~~~")
                        print("--> Please provide the valid sex of the guest to update the guest's sex field __/\__")
                        print()
                        g=input("Enter the guest's updated Gender as either MALE or M, FEMALE or F, THIRD GENDER or TG: ").upper()
                        if g=='MALE' or g=='FEMALE' or g=='THIRD GENDER' or g=='M' or g=='F' or g=='TG' :
                            htl[j][12]=g
                            print("*** NOW GUEST'S ROOM RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                        else:
                    ...
                    print()
                    n=int(input("Enter the guest's updated Aadhaar Number: "))
                    if len(str(n))==12:
                        htl[j][14]=n
                        print("*** GUEST'S ROOM RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    else:
                        ...
                        print("*** GUEST'S ROOM RECORD HAS NOT BEEN UPDATED !!! ***")
                        print("~~~ Invalid aadhaar number of the guest has been entered !!! ~~~")
                        print("--> Please provide the valid aadhaar number of the guest to update the guest's aadhaar number field __/\__")
                        print()
                        print("// Note:- Aadhaar number must be of 12 digits \\")
                        n=int(input("Enter the guest's updated Aadhaar Number: "))
                        if len(str(n))==12:
                    ...
                    print()
                    print("// Note:- Mobile/Phone number must be of 10 digits (without ISD code) \\")
                    p=int(input("Enter the guest's updated Mobile/Phone Number: +91 "))
                    if len(str(p))==10:
                        htl[j][3]=p
                        print("*** GUEST'S ROOM RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    else:
                        ...
                        print("*** GUEST'S ROOM RECORD HAS NOT BEEN UPDATED !!! ***")
                        print("~~~ Invalid mobile/phone number of the guest has been entered !!! ~~~")
                        print("--> Please provide the valid mobile/phone number of the guest to update the guest's mobile/phone number field __/\__")
                        print()
                        print("// Note:- Mobile/Phone number must be of 10 digits (without ISD code) \\")
                        p=int(input("Enter the guest's updated Mobile/Phone Number: +91 "))
                        if len(str(p))==10:
                    ...
                    print()
                    e=input("Enter the guest's updated Email Address: ")
                    if '@' and '.com' in g_email:
                        htl[j][4]=e
                        print("*** GUEST'S ROOM RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    else:
                        ...
                        print("*** GUEST'S ROOM RECORD HAS NOT BEEN UPDATED !!! ***")
                        print("~~~ Guest's email address doesn't contain '@' or '.com' !!! ~~~")
                        print("--> Please provide the proper email address of the guest to update the guest's email address field __/\__")
                        print()
                        g_email=input("Enter the guest's updated Email Address: ")
                        if '@' and '.com' in g_email:
                            htl[j][4]=e
                            print("*** NOW GUEST'S ROOM RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                        else:
                    ...
                    print()
                    h=input("Enter the guest's updated House Address: ")
                    htl[j][5]=h
                    print("*** GUEST'S ROOM RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")

                elif ch=='A':
                    print()
                    a=input("Enter the guest's updated Age: ")
                    htl[j][2]=a
                    print("*** GUEST'S ROOM RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")

                elif ch=='D':
                    print()
                    ci=input("Enter the guest's updated Check-in Date (DD/MM/YYYY): ")
                    co=input("Enter the guest's updated Check-out Date (DD/MM/YYYY): ")
                    date_format = "%d/%m/%Y"
                    ...
                    print()
                    ROOM_INFO()
                    rt=input("Enter the guest's updated Room Type: ")
                    htl[j][8]=rt
                    print("*** GUEST'S ROOM RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    ...
                    print()
                    rn=input("Enter the guest's updated Room Number: ")
                    htl[j][13]=rn
                    print("*** GUEST'S ROOM RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
